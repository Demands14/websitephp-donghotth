<?php 
    trait NewsModel{
        ...
        public function modelUpdate(){
            ...
            $conn = Connection::getInstance();
            //chuan bi truy van
            $query = $conn->prepare("update news set name=:var_name,about=:var_about,content=:var_content,hot=:var_hot where id=:var_id");
            //thuc thi truy van, co truyen tham so vao cau lenh sql
            $query->execute(["var_id"=>$id,"var_name"=>$name,"var_about"=>$about,"var_content"=>$content,"var_hot"=>$hot]);
            //---
        ...
        public function modelCreate(){
            ...
            */
            ...
            //update name           
            //chuan bi truy van
            $query = $conn->prepare("insert into news set name=:var_name,about=:var_about,content=:var_content,hot=:var_hot,photo=:var_photo");
            //thuc thi truy van, co truyen tham so vao cau lenh sql
            $query->execute(["var_name"=>$name,"var_about"=>$about,"var_content"=>$content,"var_hot"=>$hot,"var_photo"=>$photo]);
