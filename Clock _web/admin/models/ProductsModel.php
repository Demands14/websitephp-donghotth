<?php 
	trait ProductsModel{
		...
		public function modelUpdate(){
			...
			$conn = Connection::getInstance();
			//chuan bi truy van
			$query = $conn->prepare("update products set name=:var_name,about=:var_about,content=:var_content,hot=:var_hot ,price=:var_price,discount=:var_discount,category_id=:var_category_id,fields_id=:var_fields_id where id=:var_id");
			//thuc thi truy van, co truyen tham so vao cau lenh sql
			$query->execute(["var_id"=>$id,"var_name"=>$name,"var_about"=>$about,"var_content"=>$content,"var_hot"=>$hot, "var_price"=>$price, "var_discount"=>$discount, "var_category_id"=>$category_id, "var_fields_id"=>$fields_id]);
			//---
		...
		public function modelCreate(){
			...
			*/
			...
			//update name			
			//chuan bi truy van
			$query = $conn->prepare("insert into products set name=:var_name,about=:var_about,content=:var_content,hot=:var_hot,photo=:var_photo,price=:var_price, discount=:var_discount, category_id=:var_category_id, fields_id=:var_fields_id");
			//thuc thi truy van, co truyen tham so vao cau lenh sql
			$query->execute(["var_name"=>$name,"var_about"=>$about,"var_content"=>$content,"var_hot"=>$hot,"var_photo"=>$photo, "var_price"=>$price, "var_discount"=>$discount, "var_category_id"=>$category_id, "var_fields_id"=>$fields_id]);
